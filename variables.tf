...
variable "tg_name" {
    ...
    type        = string
    default     = "checkpoint-tg"
}

variable "health_port" {
    description = "Port Used by the GWLB to perform health checks on targets. "
    type        = number
    default     = "443"
}
...
variable "spoke1_cidr" {
    description = "CIDR Block of Spoke1 VPC"
    type        = string
    default     = "10.2.0.0/16"
}

variable "spoke1_subnet_az" {
    description = "AZ for Spoke1_Subnet"
    type        = string
    default     = "us-west-2a"
}

variable "spoke1_subnet" {
    description = "CIDR Block of Spoke1 Subnet in chosen AZ"
    type        = string
    default     = "10.2.0.0/24"
}